...
app.layout = html.Div([html.H1("Market Data Analysis", style={"textAlign": "center"}), dcc.Markdown('''
...
and the second one is the [Facebook metrics Data Set](https://archive.ics.uci.edu/ml/datasets/Facebook+metrics). This dashboard is divided in 3 main tabs. In the first one you can choose whith which other companies to compare Facebook Stock Prices to anaylise main trends.
